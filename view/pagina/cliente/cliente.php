<div class="content-wrapper" style="height:3000px">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Cliente  <button type="button" class="btn btn-success btn-flat" name="button" data-toggle="modal" data-target="#md-reg-cliente"  >Nuevo Cliente</button>
             </h1>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      ...
      <?php include 'modelo/md-cliente.php'; ?>
    <!-- /.content -->
  </div>
