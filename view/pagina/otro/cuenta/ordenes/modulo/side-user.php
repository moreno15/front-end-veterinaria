<div class="col-lg-4  side-hidden-user">
  ...
  <nav class="list-group">
      <a class="list-group-item with-badge  active " href="<?php echo $path."orders" ?>"> <i class="icon-shopping-bag"></i>Mis Ordenes<span class="badge badge-default badge-pill">6</span></a>
      <a class="list-group-item   " href="<?php echo $path."perfil" ?>"><i class="icon-user"></i>Datos Personales</a>
