...
<div class="row  row-card">
  <div class="container tab-content" style="border:none;">
                   ...
                   <div class="product-card-body" >
                     <div class="product-category">Marca </div>
                       <h3 class="product-title" >
                         <a href="<?php echo $path."product/".$value->url_product ?>"   ><?php echo  $value->id_product."=". $value->name_product ?></a>
                       </h3>
          ...
          <div class="row" style="margin-bottom:20px;background:#fff" >
            ...
            <div class="col-lg-8 col-md-4 col-sm-6" >
              <h5 class="product-title" style="padding-top:10px">
                <a  style="color:#000 " href="<?php echo $path."product/".$value->url_product ?>"   ><?php echo  $value->name_product ?></a></h5>
                <div class="raiting-product"  >
                  <?php
